// mengakses data pelanggan ke2 dari init data
...
public class Beli {
    ...
    static Pelanggan pelanggan2 = new Pelanggan("CT009", "kim", "Pria", 30121995, "Busan", "Platinum",4000);

    static Penjualan penjual2 = new Penjualan(kassa1, barang, pelanggan2);
    static int d;
                            ...
                            try {
                                ...
                                if(b<dis){
                                    ...
                                    while(ans){
                                        ...
                                        String a = j.toLowerCase();
                                        if(a.equals("y")){
                                            System.out.println(penjual2.tampilsisa());
                                            System.out.println("        Terima Kasih...        ");
                                            ans= false;
                                        }
                                        else if(a.equals("n")){
    ...
    public static int update12(){
        int sisa = barang1.getJumlahbarang() - penjual2.getBarangbeli();
        return sisa;
    }    
    ...
    public static void bill1(){
        System.out.println(penjual2.toString1());
        System.out.println("Barang             =  " + barang1.getNamabarang() + "\n" );
        System.out.println("Jumlah Barang      =  " + penjual2.getBarangbeli() + "\n");
    }
    

    public static int update23(){
        int sisa = barang2.getJumlahbarang() - penjual2.getBarangbeli();
        return sisa;
    }    
    ...
    public static int update33(){
        int sisa = barang3.getJumlahbarang() - penjual2.getBarangbeli();
        return sisa;
    }    
