...
// data akan disimpan dalam Readnwrt.txt

class Readnwrite{
    public static void writen(ArrayList<Satpam> satpam){
        String tempat ="Users/Richard/Documents/GitHub/Tugas-Akhir-PBO/Tracker/Readnwrt.txt";
        String data = "";
        ...
        try{
           ...
           for (Satpam satpam2 : satpam) {
               data += satpam2.tampilkansemuadata();
           }
