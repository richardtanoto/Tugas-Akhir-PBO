...
public class DataSatpam {
    static Scanner inputdata = new Scanner(System.in);
    static Satpam satpam = new Satpam();
    static Ceksatpam ceksatpam = new Ceksatpam();

    public static void datasatpam(){
        try {
            boolean n = true;
            while(n){
        ...
        do { 
            try {
                ...
                if(shift == 0 || shift <0){
                    ...
                    satpam.setShift(shift); 
                    p = false;
                    ceksatpam.ceksatpam1(satpam);
                }
                else if(shift > 200){
